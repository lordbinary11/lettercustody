...
interface ImprovedCashOfficeDashboardProps {
  incomingLetters: Letter[];
  processingLetters: Letter[];
  processedLetters: Letter[];
}

export function ImprovedCashOfficeDashboard({
  incomingLetters,
  processingLetters,
  processedLetters,
}: ImprovedCashOfficeDashboardProps) {
        ...
        <div className="p-6">
          {filteredLetters.length > 0 ? (
            ...
            <EmptyState
              ...
              description={
                activeTab === 'incoming'
                  ? 'Waiting for letters to be dispatched to Cash Office department'
